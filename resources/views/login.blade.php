...
<head>
    ...
    <!-- Favicon -->
    <link href="/kapal/img/favicon.ico" rel="icon">
...
<body>
    ...
    <div class="container-fluid page-header py-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Login Aplikasi</h1>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="username" id="name"
                                            placeholder="Your Name" autocomplete="new-password"
                                            value="{{old('username')}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" name="password" id="text"
                                            placeholder="Your text" autocomplete="new-password"
                                            value="{{old('password')}}">
